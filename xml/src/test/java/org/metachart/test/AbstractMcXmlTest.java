...
public abstract class AbstractMcXmlTest <T extends Object>
{
	...
	public AbstractMcXmlTest(){this(null,null);}
	public AbstractMcXmlTest(Class<T> cXml,String xmlDirSuffix)
	{
		debug=true;
		this.cXml=cXml;
