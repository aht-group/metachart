...
(function () {
  var callWithJQuery;
  callWithJQuery = function callWithJQuery(pivotModule) {
    if (( false ? 0 : _typeof(exports)) === "object" && ( false ? 0 : _typeof(module)) === "object") {
      return pivotModule(__webpack_require__(692));
    } else if (true) {
      return !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(692)], __WEBPACK_AMD_DEFINE_FACTORY__ = (pivotModule),
  ...
  callWithJQuery(function ($) {
    return $.pivotUtilities.export_renderers = {
      "TSV Export": function TSV_Export(pivotData, opts) {
...
( function( factory ) {
	...
	if ( true ) {
		...
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(692), __webpack_require__(883) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else {}
...
(function (factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(692)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
			return factory($);
...
var sortable = __webpack_require__(285);
// EXTERNAL MODULE: ./node_modules/jquery-ui/ui/effect.js
var effect = __webpack_require__(26);
// EXTERNAL MODULE: ./node_modules/jquery.easing/jquery.easing.js
var jquery_easing = __webpack_require__(631);
// EXTERNAL MODULE: ./node_modules/pivottable/dist/pivot.js
var pivot = __webpack_require__(178);
// EXTERNAL MODULE: ./src/js/export_renderers.js
var export_renderers = __webpack_require__(894);
// EXTERNAL MODULE: ./node_modules/file-saver/dist/FileSaver.min.js
var FileSaver_min = __webpack_require__(213);
;// ./src/pivot_aht_functions.ts
function saveRowColumnConfig(sourceId) {
    console.log("pivotSave detected");
    var config = $('#output').data('pivotUIOptions');
    var rows = config.rows.toString();
...
var pivot_$ = __webpack_require__(692);
window.$ = pivot_$;
window.JQuery = pivot_$;
...
window.saveRowColumnConfig = saveRowColumnConfig;

})();

/******/ })()
;
//# sourceMappingURL=pivot.bundle.js.map